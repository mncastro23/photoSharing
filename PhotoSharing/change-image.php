...
$oldprofilepic="uploadpic"."/".$oldppic;
...
move_uploaded_file($_FILES["imgPath"]["tmp_name"],"uploadpic/".$imgnewfile);
  // Query for data insertion
      $sql = "update  tUpload set imgPath= '$imgnewfile' where imgID='$eid'";
...
<input type="hidden" name="oldpic" value="<?php  echo $img['imgPath'];?>">
...
<img src="uploadpic/<?php  echo $img['imgPath'];?>" width="120" height="120" class="centerimg">
         ...
         <div class="form-group">
        	...
        	<center><span style="color:red; font-size:12px;">Only jpg / jpeg/ png /gif format allowed.</span></center>
